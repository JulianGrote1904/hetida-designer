...
def validate_prepared_series(prepared: pd.Series, cutoff_period: pd.Timedelta, order: int, forward_backward: bool) -> float:
...
COMPONENT_INFO = {
    ...
    "version_tag": "1.0.0",
    "id": "c0ae0775-afad-4a3e-88c6-66bda211894a",
    "revision_group_id": "c0ae0775-afad-4a3e-88c6-66bda211894a",
    "state": "DRAFT",
}
