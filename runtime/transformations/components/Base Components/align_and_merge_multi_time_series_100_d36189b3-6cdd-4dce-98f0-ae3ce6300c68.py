...
align_and_merge_100 = import_comp("1c57159c-4880-4c79-bc73-d9864ba0f946")
...
def validate_inputs(
    ...
    align_and_merge_100.validate_inputs(
...
def merge_metric_series(
    ...
    for next_series in ordered_series[1:]:
        combined = align_and_merge_100.main(
...
COMPONENT_INFO = {
    ...
    "version_tag": "1.0.0",
    "id": "d36189b3-6cdd-4dce-98f0-ae3ce6300c68",
    "revision_group_id": "d36189b3-6cdd-4dce-98f0-ae3ce6300c68",
    "state": "DRAFT",
}
