...
9. The final jump mask and event table are returned.
...
COMPONENT_INFO = {
    ...
    "description": "Detect jumps and return mask and event table.",
    "version_tag": "1.0.0",
...
def main(
    *,
    ...
    # Step 11: Build outputs (mask + event table).
