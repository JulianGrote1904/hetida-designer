...
8. Returns the processed series and masks.
...
COMPONENT_INFO = {
    ...
    "description": "Detect and optionally fill gaps in time series, returning masks.",
    "version_tag": "1.0.1",
    "id": "c6517528-dcd0-4d6c-b28a-0ea97b34fe35",
...
def main(
    *,
    ...
    max_gap_length=parse_default_value(COMPONENT_INFO, "max_gap_length"),
